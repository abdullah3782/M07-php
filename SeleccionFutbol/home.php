...
$icono = [
    ...
    [ "Nombre"=> "Oihan_sancet", "Nª Camiseta"=> "16", "goles"=> rand(0, 15), "numeroPartidos"=> rand(0, 15), "nombre_archivo"=> 16, "pais"=> $paisEspana, "posicion"=> $posicionesFutbol[rand(0, count($posicionesFutbol) - 1)]] , 
